...
CREATE TABLE `__new_tasks` (
	...
	CONSTRAINT "tasks_pending_review_kind_enum" CHECK("__new_tasks"."pending_review_kind" IS NULL OR "__new_tasks"."pending_review_kind" IN ('plan','deliverable','conflict','empty')),
